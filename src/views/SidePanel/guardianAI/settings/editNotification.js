...
const EditNotification = ({modalOpen, handleCloseModal, notificationData, messageCampaign}) => {
    ...
    const onSubmit = (data) => {
        ...
        const obj = {
            ...
            messageActiveStatus: notificationData.messageActiveStatus,
    ...
    useEffect(() => {
        setValue("notificationBody", notificationData?.body)
        setCount(notificationData?.body?.length)
    }, [notificationData])
    ...
    return (
        <div>
            <Modal isOpen={modalOpen} toggle={handleCloseModal} className="custom-modal modal-dialog-centered">
                <ModalHeader toggle={handleCloseModal}>Notification Editor</ModalHeader>
                <ModalBody>
                    <Form
                                ...
                                <Controller
                                    ...
                                    render={({ field: {onChange, value} }) => (
                                        <div className="floating email-edit-floating position-relative">
                                            ...
                                            <div className='w-100'>
                                                <textarea id="input__emailbody" className="floating__input form-control" value={value} name="emailBody" placeholder='EmailAccount Number' maxlength={500} onChange={(e) => {
